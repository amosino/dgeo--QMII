...
### La función de autocorrelación parcial (1/3)
...
### La función de autocorrelación parcial (2/3)
...
### La función de autocorrelación parcial (3/3)
...
La FACP mide la correlación entre \(y_t\) y \(y_{t-k}\) eliminando el efecto de los rezagos intermedios. Esto es, mide la correlación “directa” entre dos observaciones separadas por \(k\) periodos.


### La función de autocorrelación parcial: Ejemplo

Se puede demostrar, por ejemplo que, para un proceso AR(\(2\)), la función de autocorrelación parcial es:
